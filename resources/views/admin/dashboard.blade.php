        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <x-dashboard-card
                    ...
                    description="Manage community and surau events."
                ...
                <x-dashboard-card
                    ...
                    description="Track and manage surau income/expenses."
                ...
                <x-dashboard-card
                    ...
                    description="Manage bookings for facilities/areas."
                    route="{{ route('admin.facility-bookings.index') }}"
                    color="bg-teal-600"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-20">
                ...
                <x-dashboard-card
                    title="Voting & Polls"
                    description="Create and monitor community votes."
                    route="{{ route('admin.votings.index') }}"
                    color="bg-blue-600"
                >
