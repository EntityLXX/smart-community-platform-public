    ...
    <div class="py-6 px-6">
        ...
        <div class="relative max-w-4xl mx-auto ring-2 ring-purple-500 rounded-3xl">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 space-y-6 z-10">
                <form id="eventCreateForm" action="{{ route('admin.events.store') }}" method="POST"
                    ...
                    {{--@if ($errors->any())
                    <div class="mb-6 mt-2 p-4 bg-red-100 text-red-600 rounded">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 block w-full rounded-md shadow-sm border-gray-300 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="picture" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Picture
                            (optional)</label>
